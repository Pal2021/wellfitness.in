...
export default function App() {
  return (
    <Routes>
      {/* Landing & Auth */}
      <Route path="/welcome" element={<AuthRoute><LandingScreen /></AuthRoute>} />
      ...
      <Route path="/ai-coach" element={<ProtectedRoute><AiCoachScreen /></ProtectedRoute>} />
      ...
      <Route path="/phase/:id" element={<ProtectedRoute><PhaseDetailScreen /></ProtectedRoute>} />
